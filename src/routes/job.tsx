...
export const Route = createFileRoute("/job")({
  head: () => ({
    meta: [
      {
        title:
          "Generate Application — FumanAI",
      },
      {
        name: "description",
        content:
          "Paste a job advertisement and generate an ATS-friendly CV, cover letter, and application email tailored to it.",
      },
      {
        property: "og:title",
        content:
      ...
      },
      {
        ...
        content:
          "Paste a job ad. Get a tailored CV, cover letter, and email.",
      },
    ],
  }),
...
function renderCvText(
  cv: GeneratedApplication["cv"]
): string {
  const lines: string[] = [];
  ...
  if (
    ...
    cv.additionalInformation.forEach(
      (information) => {
        lines.push(
          `• ${information}`
        );
        ...
        async (
          ...
          if (
            ...
            try {
              ...
              toast.success(
                "Application generated and added to Job Tracker"
              );
            } catch (error) {
              console.error(
                "Failed to add job:",
              ...
              toast.error(
                "Application generated, but the Job Tracker could not be updated."
              );
            }
          }
        },
